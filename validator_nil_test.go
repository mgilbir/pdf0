...
var nilDocumentValidators = map[string]func() []error{
	...
	"ValidateFacturX":        func() []error { return errs(ValidateFacturX(nil).Violations) },
	"ValidateFacturXContext": func() []error { return errs(ValidateFacturXContext(context.Background(), nil).Violations) },
	"ValidateOrderX":         func() []error { return errs(ValidateOrderX(nil).Violations) },
	"ValidateOrderXContext":  func() []error { return errs(ValidateOrderXContext(context.Background(), nil).Violations) },
}
