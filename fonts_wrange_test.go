...
func TestParseCIDWidthsBoundsRange(t *testing.T) {
	...
	arr, _ := parseCIDWidths(doc, Array{Integer(5), Array{Real(1), Real(2), Real(3)}})
	...
	full, _ := parseCIDWidths(doc, Array{Integer(0), Integer(65535), Real(1000)})
	if len(full) != 65536 {
