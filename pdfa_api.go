...
// ValidationError is a PDF/A conformance failure.
type ValidationError = pdfa.ValidationError

// PDFALevel names a PDF/A conformance level.
type PDFALevel = pdfa.PDFALevel
