...
func TestParseCIDWidthsBoundsRange(t *testing.T) {
	...
	hostile, _ := parseCIDWidths(doc, object.Array{object.Integer(0), object.Integer(2_000_000_000), object.Real(500)})
	if len(hostile) != 0 {
	...
	valid, _ := parseCIDWidths(doc, object.Array{object.Integer(10), object.Integer(12), object.Real(500)})
	...
	arr, _ := parseCIDWidths(doc, object.Array{object.Integer(5), object.Array{object.Real(1), object.Real(2), object.Real(3)}})
	...
	full, _ := parseCIDWidths(doc, object.Array{object.Integer(0), object.Integer(65535), object.Real(1000)})
	if len(full) != 65536 {
